# Dicionário de Tradução – Legend in the Mist

> Referência de termos padronizados para tradução do inglês para o português brasileiro.
> **Regra geral:** O termo *Legend in the mist* **nunca** deve ser traduzido.

---

## Termos do Sistema de Jogo

| Inglês | Português | Notas |
|---|---|---|
| Tag(s) | Rótulo(s) | Descritor curto no sistema do jogo |
| Story tag | Rótulo de história | |
...
| Theme kit | Kit de tema | |
| Trope(s) | Tropo(s) | |
| Power tag | Rótulo de poder | |
| Weakness tag | Rótulo de fraqueza | |
| Scratched | Riscado | Estado de um rótulo usado |
...
| Inglês | Português | Notas |
|---|---|---|
| Hero(es) | Herói(s) | Sempre capitalizado |
| Narrator | Narrador | Sempre capitalizado |
| Fellowship | Companhia | Grupo de Heróis |
| NPC | NPC | Mantido em inglês |
| Challenge(s) | Desafio(s) | Adversários/obstáculos no sistema |
| Adversary / Adversaries | Adversário(s) | |
...
| Solo | Solo | |
| Co-op | Cooperativo | |
| Play-by-post | Play-by-post | Mantido em inglês |
| Initiative | Iniciativa | |
| Establish | Estabelecer | Fase do jogo |
| Action | Ação | Fase do jogo |
| Consequences | Consequências | Fase do jogo |
| Threat | Ameaça | Ação do Narrador |
...
| Inglês | Português | Notas |
|---|---|---|
| The Tutorial | O Tutorial | |
| The Makings of a Hero | A Criação de um Herói | |
| How To Play | Como Jogar | |
| How to Play, in a nutshell | Como Jogar, em resumo | |
| The Secret of Magic | O Segredo da Magia | |
| Ways of Magic | Formas de Magia | |
| The Narrator's Role | O Papel do Narrador | |
| The Satchel of Perils | A Algibeira de Perigos | |
| The Oracle | O Oráculo | |
| Action Grimoire | Grimório de Ação | Suplemento separado |
| Narrator's Screen | Escudo do Narrador | |

## Acessórios e Dados

| Inglês | Português | Notas |
|---|---|---|
| Acorn Dice | Dados de Bolota | Dados d6 temáticos |
| River Pebble Dice | Dados de Seixo de Rio | Dados d12 que funcionam como d6 |
| Six-sided dice (d6) | Dados de seis lados (d6) | |
| Lines & Veils | Linhas & Véus | Ferramenta de segurança |
| Safety tools | Ferramentas de segurança | |

## Enquadramentos de Jogo (Frames of Play)
...
| Termo | Notas |
|---|---|
| Legend in the mist | Nome do jogo – nunca traduzir |
...
| Wholesome rewards | Recompensas saudáveis | |
| Emotional rewards | Recompensas emocionais | |
| Roleplaying game (RPG) | Jogo de interpretação de papéis (RPG) | |
...
| Companion | Companheiro | Tipo de Tema de Poderio variante |
...
| hated and reviled	| odiado e execrado
| strong as an ox	| forte como um boi
| wise	| sábio
| alert	| alerta
| flexible joints	| juntas flexíveis
| natural climber	| escalador nato
| noble upbringing	| criação nobre
| seasoned merchant	| comerciante experiente
| farmer	| fazendeiro
| grizzled scout	| batedor grisalho
| knows the Dales	| conhece os Vales
| satchel of herbs	| sacola de ervas
| good quality rope	| corda de boa qualidade
| elven-made bow	| arco feito por elfos
| bag full of coins	| saco cheio de moedas
| hunter's lodge	| cabana de caçador
| loyal horse	| cavalo leal
| my squire	| meu escudeiro
| web of spies	| rede de espiões
| raise the dead	| erguer os mortos
| my helpful sprite	| minha fada prestativa
| brave	| corajoso
| village protector	| protetor da vila
| unscrupulous friends	| amigos inescrupulosos
| see through lies	| ver através das mentiras
| tavern charmer	| charme de taverna
| hunter's lodge	| cabana de caçador
| swordsmanship	| esgrima
| sowing	| plantar mudas
| spell weaving	| tecelão de feitiços
| pickpocketing	| batedor de carteiras
| ancient languages	| línguas antigas
| tumble out of harm	| rolar para fora do perigo
| keen eyesight	| visão aguçada
| cast a fireball	| lançar uma bola de fogo
| speak with the dead	| falar com os mortos
| turn invisible	| ficar invisível
| old bones	| ossos velhos
| rusty and fragile	| enferrujado e frágil
| ostracized	| ostracizado
| afraid of spiders	| medo de aranhas
| can't bewitch the fae	| não pode encantar as fadas
| Alderperson	| Membro do Conselho
| Fugitive	| Fugitivo
| Hardworking Drudge	| Trabalhador Árduo
| Landed Noble	| Nobre Dono de Terras
| Outcast	| Exilado
| Tavern Brawler	| Brigão de Taverna
| Ailing Wise Elder	| Ancião Sábio Enfermo
| Become a Knight	| Tornar-se Cavaleiro
| Childhood Sweetheart	| Amor de Infância
| Heal the Sick	| Curar os Doentes
| Our Village	| Nossa Vila
| Ritualistic Circle	| Círculo Ritualístico
| Cursed	| Amaldiçoado
| Forged in War	| Forjado na Guerra
| Highborn Education	| Educação da Alta Sociedade
| Last of My Kind	| Último da Minha Espécie
| Mystic Pilgrimage	| Peregrinação Mística
| Well-Traveled	| Bem Viajado
| Battlerider	| Cavaleiro de Batalha
| Beaver Kin	| Povo Castor
| Caravan Folk	| Povo da Caravana
| Highlander	| Morador das Montanhas
| Sylvan Elf	| Elfo Silvestre
| Witchblood	| Sangue de Bruxa
| Curious	| Curioso
| Gruff	| Rude
| Heart of Gold	| Coração de Ouro
| Jovial Disposition	| Disposição Jovial
| Practiced Liar	| Mentiroso Experiente
| Rummormonger	| Fofoqueiro
| Artisan	| Artesão
| Blacksmith	| Ferreiro
...
| Strong As An Ox	| Forte Como Um Boi
| Tenacious	| Tenaz
| Uncommon Beauty	| Beleza Incomum
| Underwater Deftness	| Destreza Subaquática
| A Light Against the Dark	| Uma Luz Contra a Escuridão
| Contract Work	| Trabalho por Contrato
| Oath of Allegiance	| Juramento de Fidelidade
| Postal Courier	| Mensageiro Postal
| Protect the Land	| Proteger a Terra
| Yearns for Revenge	| Anseia por Vingança
| Adored	| Adorado
| Conspirator	| Conspirador
| Dockmaster	| Mestre das Docas
| Folk Hero	| Herói do Povo
| Respected Leader	| Líder Respeitado
| [Deity]'s Favored Cleric	| Clérigo Favorecido de [Divindade]
| Denizens of the Unseen	| Habitantes do Invisível
| Expert Appraiser	| Avaliador Especialista
| Monster Lore	| Conhecimento sobre Monstros
...
| Bag of Enchanted Dust	| Saco de Pó Encantado
| Cauldron of Conjuration	| Caldeirão de Conjuração
| Giant's Gauntlet	| Manopla de Gigante
| Heirloom Longsword	| Espada Longa de Herança
| Magic Seeds	| Sementes Mágicas
...
| Find the Celestial Storyteller	| Encontrar o Contador de Histórias Celestial
| Foretold Demise	| Morte Anunciada
| Slay the Mighty One	| Matar o Todo-Poderoso
| Turn the Tides of Darkness	| Mudar os Rumos da Escuridão
| Archmage of the Order	| Arquimago da Ordem
| Insidious Cult Overlord	| Soberano de Culto Insidioso
| Merchant Guildmaster	| Mestre de Guilda Mercante
| Monarch	| Monarca
| Otherworldly Realm	| Reino de Outro Mundo
| Terror of the Land	| Terror do País
| Ambassador of Change	| Embaixador da Mudança
| Forger of Celestial Jewels	| Forjador de Joias Celestiais
| Inspired Architect	| Arquiteto Inspirado
| Lord of the Hunt	| Senhor da Caçada
| Mastermind General	| General Mestre Inteleto
| Perfected Soul	| Alma Aperfeiçoada
| Archfiend of Bedlam	| Arquidemônio do Caos
| Dragon	| Dragão
| Powerful Vampire	| Vampiro Poderoso
| Elemental Titan	| Titã Elemental
| Giant Spider Queen	| Aranha Rainha Gigante
| God-Spirit	| Espírito de Deus
...
| Hex & Curse	| Feitiço & Maldição
| Grand Necromancy	| Grande Necromancia
| One with the Dark	| Um com as Trevas
| Rudimentary Magic	| Magia Rudimentar
...
| Expert Poisoner	| Especialista em Venenos
| Greenkeeper	| Zelador do Verde
| Village Apothecary	| Boticario da Vila
| Boisterous Bard	| Bardo Espalhafatoso
| Champion of the Fair Folk	| Campeão do Povo das Fadas
| Foxy Trickster	| Trapaceiro Astuto
| Herald of Summer	| Arauto do Verão
| Magic of the Household Hob	| Magia da Fada Guia do Lar
| Hoary Avenger	| Vingador Ancião
| Primal Earthshaper	| Moldador Ancestral de Terra
| Town Geomancer	| Geomante de Cidade
| Woodland Whisperer	| Sussurrador da Floresta
| Blazing Invoker	| Invocador de Chamas
| Rune Sage	| Sábio Rúnico
| Runescribing	| Escritura de Runas
| Tattooed Sigils	| Símbolos Tatuados
| Beast-Dreamer	| Visionário das Feras
| Doppelganger	| Doppelganger
| Elemental Body	| Corpo Elemental
| Werewolf Form	| Forma de Lobisomem
| Eldritch Archmage	| Arquimago Abissal
| Spellsword	| Espadachim Arcano
| Untrained Potential	| Potencial Destreinado
| Wandering Wizard	| Mago Andarilho
| Ancestor Worship	| Culto aos Ancestrais
| Demon Binding	| Conexão Demoníaca
| Caller of Nature Spirits	| Invocador de Espíritos da Natureza
| Familiar Master	| Mestre de Familiares
| Coven Witch	| Bruxa do Conclave
| Cult Initiate	| Iniciado do Culto
| Hedge Witch	| Bruxa Solitária
| Tribe Soothsayer	| Vidente da Tribo
...
| Skill Or Trade | Habilidade ou Ofício
| Relic | Relíquia
